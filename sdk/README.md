...
The JavaScript half of the local-first sync SDK: a thin, build-step-free ESM
...
- `package.json` — package metadata plus the wasm/admin-bundle build scripts.

The wasm reconcile logic lives in the Rust crate at the repo root (`../src`); this
package is `@fiducia/sync`, consumed by the fiducia.cloud frontends.
